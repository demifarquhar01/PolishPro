...
Container_Boundary(salonSys, "Nail Salon System") {
    Container(webApp, "Web App", "React", "Interface for booking and managing services.")
...
Rel(api, database, "Interacts with", "JDBC")
Rel(api, emailService, "Communicates with", "SMTP")

UpdateElementStyle(customer, $fontColor="white", $bgColor="#FFB6C1", $borderColor="#FF69B4")
UpdateElementStyle(admin, $fontColor="white", $bgColor="#FFD700", $borderColor="#FF69B4")
UpdateElementStyle(webApp, $fontColor="white", $bgColor="#BA55D3", $borderColor="#FF69B4")
UpdateElementStyle(api, $fontColor="white", $bgColor="#F0E68C", $borderColor="#DAA520")
UpdateElementStyle(emailService, $fontColor="black", $bgColor="#FF69B4", $borderColor="#FF69B4")
UpdateElementStyle(database, $fontColor="white", $bgColor="#FFC0CB", $borderColor="#FF69B4")

UpdateRelStyle(customer, webApp, $textColor="#FF69B4", $lineColor="#FF69B4", $offsetY="-5")
UpdateRelStyle(admin, webApp, $textColor="#FF69B4", $lineColor="#FF69B4", $offsetY="5")
UpdateRelStyle(webApp, api, $textColor="#FF69B4", $lineColor="#FF69B4", $offsetY="15")
UpdateRelStyle(api, database, $textColor="#FF69B4", $lineColor="#FF69B4", $offsetY="25")
UpdateRelStyle(api, emailService, $textColor="#FF69B4", $lineColor="#FF69B4", $offsetY="35")
...
Container_Boundary(api, "API Application") {
    ...
    Component_Ext(webApp, "Web Application", "React", "Interface for booking and managing services.")
