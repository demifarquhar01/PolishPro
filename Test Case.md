...
| TC-006 | FR-006 | User cancels an appointment | 1. Log in to the system. 2. Navigate to the "My Appointments" section. 3. Locate the appointment to be canceled and click the "Cancel" button. 4. Select "Yes" to confirm or "No" to keep the appointment. | Appointment is successfully canceled, and a cancel notification is sent via email.| | |
| TC-007 | FR-007 | User reschedules an appointment | 1. Log in to the system. 2. Navigate to the "My Appointments" section. 3. Locate the appointment to be rescheduled and click the "Reschedule" button. 4. Select a new available date and time from the provided options. 5. Click "Confirm" to proceed. 6. Select "Yes" to confirm or "No" to cancel the action. | Appointment is successfully rescheduled, and email sent out of reschedule date. | | |
